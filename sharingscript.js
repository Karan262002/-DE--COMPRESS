    ...
    var selectedOption = document.getElementById('shareOptions').value;
    if (selectedOption === 'gmail') {
      // Handle Gmail sharing
      window.location.href = 'mailto:?subject=Compressed%20File&body=Please%20find%20the%20compressed%20file%20attached.&attachment=' + encodeURIComponent(document.getElementById('compressedFileLink').href);
    } else if (selectedOption === 'whatsapp') {
      // Handle WhatsApp sharing
      window.location.href = 'https://web.whatsapp.com/send?text=Please%20find%20the%20compressed%20file%20attached.%0A' + encodeURIComponent(document.getElementById('compressedFileLink').href);
    }
  });
  ...
  document.getElementById('restartButton').addEventListener('click', function() {
    ...
    document.getElementById('compressedFileLink').href = '#';
    document.getElementById('restartButton').style.display = 'none';
  });
  
//   When 'compressButton' is clicked:
//   Retrieve the selected sharing option from the 'shareOptions' element
//   If selectedOption is 'gmail':
//     // Handle Gmail sharing
//     Set the URL of the current window to:
//       'mailto:?subject=Compressed%20File&body=Please%20find%20the%20compressed%20file%20attached.&attachment=' +
//         encodeURIComponent(document.getElementById('compressedFileLink').href)
//   Else if selectedOption is 'whatsapp':
//     // Handle WhatsApp sharing
//     Set the URL of the current window to:
//       'https://web.whatsapp.com/send?text=Please%20find%20the%20compressed%20file%20attached.%0A' + 
//          encodeURIComponent(document.getElementById('compressedFileLink').href)

// When 'restartButton' is clicked:
//   Reset the 'fileUploadForm' element
